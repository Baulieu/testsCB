...
class Xlswriter:
    ...
    def write(self):
        ...
        chartImgs.set_title({'name': 'Images par seconde'})
        ...
        chartTauxProf.set_title({'name': 'récupération profondeur'})
        ...
        chartFiabTaille.set_title({'name': 'fiabilité de la taille'})
        ...
        chartNbTargets.set_title({'name': 'nombre de cibles observées'})
        ...
        chartNbPoints.set_title({'name': 'nombre de points enregistrés'})
        ...
        chartNbPertes.set_title({'name': 'nombre de pertes de cible'})
        ...
        chartPerf.set_title({'name': 'indice de performance'})
